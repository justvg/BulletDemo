...
class shader
{
	...
	public:
		...
		void Use(void);
		void SetR32(const char *Name, r32 Value);
		void SetI32(const char *Name, i32 Value);
        ...
        void SetVec2Array(const char *Name, u32 Count, vec2 *V);
};
...
void shader::SetR32(const char *Name, r32 Value)
{
    glUniform1f(glGetUniformLocation(ID, Name), Value);
}

void shader::SetI32(const char *Name, i32 Value)
{
...
void shader::SetVec2Array(const char *Name, u32 Count, vec2 *V)
{
